...
{
	return mono_assembly_names_equal_ignore_version (l,r,FALSE);
}

gboolean
mono_assembly_names_equal_ignore_version (MonoAssemblyName *l, MonoAssemblyName *r, gboolean ignore_version_and_key)
{
	if (!l->name || !r->name)
		return FALSE;
