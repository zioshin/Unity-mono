...
ICALL(GC_8, "TryExpandHeap", mono_gc_try_expand_heap)
ICALL(GC_9, "SetMaxHeapSize", mono_gc_set_max_heap_size)
ICALL(GC_10, "Enable", mono_gc_enable)
ICALL(GC_11, "Disable", mono_gc_disable)
ICALL(GC_12, "SetUseEntireHeap", mono_gc_use_entire_heap)
