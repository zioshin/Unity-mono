...
ICALL(UNITY_MBEDTLS_2 , "unity_mbedtls_ctr_drbg_init", unity_mbedtls_ctr_drbg_init)
ICALL(UNITY_MBEDTLS_3 , "unity_mbedtls_ctr_drbg_random", unity_mbedtls_ctr_drbg_random)
ICALL(UNITY_MBEDTLS_4 , "unity_mbedtls_ctr_drbg_seed", unity_mbedtls_ctr_drbg_seed)
ICALL(UNITY_MBEDTLS_5 , "unity_mbedtls_debug_set_threshold", unity_mbedtls_debug_set_threshold)
ICALL(UNITY_MBEDTLS_6 , "unity_mbedtls_entropy_free", unity_mbedtls_entropy_free)
ICALL(UNITY_MBEDTLS_7 , "unity_mbedtls_entropy_func", unity_mbedtls_entropy_func)
ICALL(UNITY_MBEDTLS_8 , "unity_mbedtls_entropy_init", unity_mbedtls_entropy_init)
ICALL(UNITY_MBEDTLS_9 , "unity_mbedtls_pk_free", unity_mbedtls_pk_free)
ICALL(UNITY_MBEDTLS_10 , "unity_mbedtls_pk_init", unity_mbedtls_pk_init)
ICALL(UNITY_MBEDTLS_11 , "unity_mbedtls_pk_parse_key", unity_mbedtls_pk_parse_key)
ICALL(UNITY_MBEDTLS_12 , "unity_mbedtls_ssl_conf_authmode", unity_mbedtls_ssl_conf_authmode)
ICALL(UNITY_MBEDTLS_13 , "unity_mbedtls_ssl_conf_ca_chain", unity_mbedtls_ssl_conf_ca_chain)
ICALL(UNITY_MBEDTLS_14 , "unity_mbedtls_ssl_conf_ciphersuites", unity_mbedtls_ssl_conf_ciphersuites)
ICALL(UNITY_MBEDTLS_15 , "unity_mbedtls_ssl_conf_dbg", unity_mbedtls_ssl_conf_dbg)
ICALL(UNITY_MBEDTLS_16 , "unity_mbedtls_ssl_conf_max_version", unity_mbedtls_ssl_conf_max_version)
ICALL(UNITY_MBEDTLS_17 , "unity_mbedtls_ssl_conf_min_version", unity_mbedtls_ssl_conf_min_version)
ICALL(UNITY_MBEDTLS_18 , "unity_mbedtls_ssl_conf_own_cert", unity_mbedtls_ssl_conf_own_cert)
ICALL(UNITY_MBEDTLS_19 , "unity_mbedtls_ssl_conf_rng", unity_mbedtls_ssl_conf_rng)
ICALL(UNITY_MBEDTLS_20 , "unity_mbedtls_ssl_conf_verify", unity_mbedtls_ssl_conf_verify)
ICALL(UNITY_MBEDTLS_21 , "unity_mbedtls_ssl_config_defaults", unity_mbedtls_ssl_config_defaults)
ICALL(UNITY_MBEDTLS_22 , "unity_mbedtls_ssl_config_free", unity_mbedtls_ssl_config_free)
ICALL(UNITY_MBEDTLS_23 , "unity_mbedtls_ssl_config_init", unity_mbedtls_ssl_config_init)
ICALL(UNITY_MBEDTLS_24 , "unity_mbedtls_ssl_free", unity_mbedtls_ssl_free)
ICALL(UNITY_MBEDTLS_25 , "unity_mbedtls_ssl_get_ciphersuite", unity_mbedtls_ssl_get_ciphersuite)
ICALL(UNITY_MBEDTLS_26 , "unity_mbedtls_ssl_get_ciphersuite_id", unity_mbedtls_ssl_get_ciphersuite_id)
ICALL(UNITY_MBEDTLS_41 , "unity_mbedtls_ssl_get_minor_ver", unity_mbedtls_ssl_get_minor_ver)
ICALL(UNITY_MBEDTLS_27 , "unity_mbedtls_ssl_get_peer_cert", unity_mbedtls_ssl_get_peer_cert)
ICALL(UNITY_MBEDTLS_42 , "unity_mbedtls_ssl_get_state", unity_mbedtls_ssl_get_state)
ICALL(UNITY_MBEDTLS_28 , "unity_mbedtls_ssl_handshake", unity_mbedtls_ssl_handshake)
ICALL(UNITY_MBEDTLS_29 , "unity_mbedtls_ssl_handshake_step", unity_mbedtls_ssl_handshake_step)
ICALL(UNITY_MBEDTLS_30 , "unity_mbedtls_ssl_init", unity_mbedtls_ssl_init)
ICALL(UNITY_MBEDTLS_31 , "unity_mbedtls_ssl_read", unity_mbedtls_ssl_read)
ICALL(UNITY_MBEDTLS_32 , "unity_mbedtls_ssl_set_bio", unity_mbedtls_ssl_set_bio)
ICALL(UNITY_MBEDTLS_33 , "unity_mbedtls_ssl_set_hostname", unity_mbedtls_ssl_set_hostname)
ICALL(UNITY_MBEDTLS_34 , "unity_mbedtls_ssl_setup", unity_mbedtls_ssl_setup)
ICALL(UNITY_MBEDTLS_35 , "unity_mbedtls_ssl_write", unity_mbedtls_ssl_write)
ICALL(UNITY_MBEDTLS_36 , "unity_mbedtls_strerror", unity_mbedtls_strerror)
ICALL(UNITY_MBEDTLS_37 , "unity_mbedtls_x509_crt_free", unity_mbedtls_x509_crt_free)
ICALL(UNITY_MBEDTLS_43 , "unity_mbedtls_x509_crt_get_next", unity_mbedtls_x509_crt_get_next)
ICALL(UNITY_MBEDTLS_44 , "unity_mbedtls_x509_crt_get_raw", unity_mbedtls_x509_crt_get_raw)
ICALL(UNITY_MBEDTLS_38 , "unity_mbedtls_x509_crt_init", unity_mbedtls_x509_crt_init)
ICALL(UNITY_MBEDTLS_39 , "unity_mbedtls_x509_crt_parse", unity_mbedtls_x509_crt_parse)
ICALL(UNITY_MBEDTLS_40 , "unity_mbedtls_x509_crt_verify", unity_mbedtls_x509_crt_verify)
