...
perl external/buildscripts/build_runtime_linux_aarch64.pl --stevedorebuilddeps=1
if [ $? -eq 0 ]
then
...
mkdir -p incomingbuilds/linux_aarch64
ls -al incomingbuilds/linux_aarch64
echo "Copying builds to incomingbuilds"
cp -r builds/* incomingbuilds/linux_aarch64/
ls -al incomingbuilds/linux_aarch64
