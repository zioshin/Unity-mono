...
BOOTSTRAP_PROFILE = unity_aot_bootstrap
...
MCS = MONO_PATH="$(topdir)/class/lib/$(BOOTSTRAP_PROFILE)$(PLATFORM_PATH_SEPARATOR)$$MONO_PATH" $(INTERNAL_SMCS)

profile-check:
	@:

PROFILE_MCS_FLAGS = -d:NET_1_1 -d:NET_2_0 -d:NET_2_1 -d:MONOTOUCH -d:UNITY -d:FULL_AOT_RUNTIME -d:DISABLE_REFLECTION_EMIT -d:DISABLE_COM
