...
system("cp incomingbuilds/osx-i386/monodistribution/bin/mono collectedbuilds/monodistribution/bin/mono") && die("failed running lipo on osx runtimes");
...
system("cp incomingbuilds/osx-i386/embedruntimes/osx/libmono.0.dylib collectedbuilds/embedruntimes/osx/libmono.0.dylib") && die("failed running lipo on libmono.0.dylib");
